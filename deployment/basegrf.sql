...
INSERT INTO pool.config (module, item, item_value, item_type, Item_desc) VALUES ('daemon', 'port', '18191', 'int', 'Graft Daemon RPC Port');
...
INSERT INTO pool.config (module, item, item_value, item_type, Item_desc) VALUES ('wallet', 'port', '18192', 'int', 'Graft Daemon RPC Wallet Port');
...
INSERT INTO pool.config (module, item, item_value, item_type, Item_desc) VALUES ('payout', 'exchangeMin', '30', 'float', 'Minimum GRF balance for payout to exchange/payment ID');
...
INSERT INTO pool.config (module, item, item_value, item_type, Item_desc) VALUES ('general', 'coinCode', 'MZT', 'string', 'Coincode to be loaded up w/ the shapeshift getcoins argument.');
...
INSERT INTO pool.config (module, item, item_value, item_type, Item_desc) VALUES ('payout', 'feeSlewAmount', '.05', 'float', 'Amount to charge for the txn fee');
...
INSERT INTO pool.users (username, pass, email, admin, payout_threshold) VALUES ('admin', null, 'Password123', 0, 0);
