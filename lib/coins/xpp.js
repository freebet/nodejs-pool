...
function Coin(data){
    ...
    this.coinDevAddress = "5nYWvcvNThsLaMmrsfpRLBRou1RuGtLabUwYH7v6b88bem2J4aUwsoF33FbJuqMDgQjpDRTSpLCZu3dXpqXicE2uSWS4LUP";  // Developer Address
    this.poolDevAddress = "5nYWvcvNThsLaMmrsfpRLBRou1RuGtLabUwYH7v6b88bem2J4aUwsoF33FbJuqMDgQjpDRTSpLCZu3dXpqXicE2uSWS4LUP";  // Pool Operator Address
    ...
    this.prefix = 372101;
	this.subPrefix = 29061;
    this.intPrefix = 28549;

    if (global.config.general.testnet === true){
        this.prefix = 1469448;
		this.subPrefix = 372744;
        this.intPrefix = 28168;
    }
    ...
    this.cryptoNight = function(convertedBlob) {
        if(convertedBlob[0] > 6)
            return multiHashing.cryptonight_fast(convertedBlob, 1);
        else
            return multiHashing.cryptonight(convertedBlob, convertedBlob[0] >= 5 ? convertedBlob[0] - 4 : 0);
    }
}
